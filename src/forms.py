...
class ArtifactForm(FlaskForm):
    ...
    mediatype = SelectField('Mediatype', choices=[('0', 'Unknown'), ('1', 'Text'), ('2', 'Video'), ('3', 'Other')], validators=[DataRequired()])
    duration = SelectField('Duration', choices=[('0', 'Unknown'), ('1', 'Minutes'), ('2', 'Days'), ('3', 'Days'), ('4', 'Months'), ('5', 'Long')], validators=[DataRequired()])
